...
export const data = [
    {
        image: userdp1,
        text: '"Lorem ipsum dolor sit ame consectetur adipisicing elit. Quaerat voluptas tenetur molestiae aliquid corporis. Nesciunt pariatur sint quia, atque deleniti temporibus nulla architecto eaque minima fugit."',
